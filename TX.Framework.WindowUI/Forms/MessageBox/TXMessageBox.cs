...
{
    public partial class TXMessageBox : CCWin.Skin_DevExpress
    {
        #region fileds
        ...
        public TXMessageBox(string message, string captionText, EnumMessageBox messageBoxMode)
            : this()
        {
            ...
            this.ResetSize();
            this.BackgroundImage = Properties.Resources.panel2_BackgroundImage;
        }
