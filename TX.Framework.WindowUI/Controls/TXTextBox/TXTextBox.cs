...
namespace TX.Framework.WindowUI.Controls
{
    ...
    public partial class TXTextBox : UserControl
    {
        ...
        private void ResetControlSize()
        {
            ...
            switch (this._ImageAlignment)
            {
                case ToolStripItemAlignment.Left:
                    ...
                    this._TextBox.Location = new Point(this._pictureBox.Width + this._Offset.Width , mid - this._TextBox.Height / 2);
                    break;
        ...
        private void InitializeComponent()
        {
            ...
            this._pictureBox.Size = new System.Drawing.Size(101, 21);
