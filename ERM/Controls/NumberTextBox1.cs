...
namespace ERM.UI
{
    public partial class NumberTextBox1 : System.Windows.Forms.MaskedTextBox //.TextBox
    {
        ...
        {
            string mathText = @"^(([1-9]\d{0," + _MaxValuelLength + "})|(0))(\\.\\d{1,20})?$";//=@"^(([1-9]\d{0,6})|(0))(\.\d{1,2})?$"  //"^(\\d+(\\.\\d+))|(\\d{1,2}+(\\.\\d{1,2}+))?$"
        ...
        {
            return Regex.IsMatch(strIn, @"^\d{1," + _MaxValuelLength + "}$");
        }
        ...
        private void _TextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (tag != "")
            {
                ...
                if ((e.KeyChar > 47 && e.KeyChar < 58 && this.Text.Length < _MaxValuelLength))
                {
                    ...
                    else if (this.Text.IndexOf(this._TextBox.SelectedText, 0) == 0 && e.KeyChar == 48 && this._TextBox.SelectedText != "" && e.KeyChar != 46 && this.Text.IndexOf('.') == -1 && this._TextBox.SelectedText.Length != this.Text.Length)
                    {
                        e.Handled = true;
                    }
                    ...
                    else if (this.Text.IndexOf(".") > -1 && this.Text.IndexOf(this._TextBox.SelectedText, 0) == 0 && e.KeyChar == 48 && this._TextBox.SelectedText.Length != this.Text.Length)
                    {
                        e.Handled = true;
                    }
                    else
