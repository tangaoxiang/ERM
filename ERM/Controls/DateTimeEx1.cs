...
namespace ERM.UI
{
    public partial class DateTimeEx1 : System.Windows.Forms.MaskedTextBox
    {
        public DateTimeEx1()
        {
            InitializeComponent();
            base.Font = new System.Drawing.Font("微软雅黑", 10F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
        }
        ...
        protected override void OnLeave(EventArgs e)
        {
            try
            {
                if (this.Text.Trim() != this.Mask.Replace("0", " ").Trim())
                {
                    DateTime d1 = DateTime.Parse(this.Text);
                }
            }
            catch
            {
                TXMessageBoxExtensions.Info("提示：日期录入格式不正确，请重新录入！\n 【温馨提示：日期格式：1900.01.01】");
                this.Text = "";
                this.Focus();
            }
        ...
        public string TextEx
        {
            set
            {
                try
                {
                    DateTime d1 = DateTime.Parse(value);
                    Text = d1.ToString("yyyy-MM-dd");
                }
                catch { Text =""; }
            }
            get
            {
                try
                {
                    return (DateTime.Parse(this.Text)).ToString("yyyy-MM-dd");
                }
                catch { }
                return "";
            }
        ...
        public DateTimeEx1(IContainer container)
            : base()
        {
            container.Add(this);
            SetStyle(
        ...
        private void InitializeComponent()
        {
            ...
            // _TextBox
            // 
            this._TextBox.BackColor = base.BackColor;
            this._TextBox.BorderStyle = System.Windows.Forms.BorderStyle.None;
            ...
            this._TextBox.Mask = "0000-00-00";
            this._TextBox.Font = new Font("微软雅黑", 10F, FontStyle.Regular);
            this._TextBox.ForeColor = System.Drawing.Color.Black;
            // 
            // _pictureBox
            // 
